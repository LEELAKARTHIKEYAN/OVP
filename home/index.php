...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    ...
    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
      <a class="dropdown-item">leelakarthikeyan.h2020@vitstudent.ac.in</a>
      <a class="dropdown-item">pranav.c2020@vitstudent.ac.in</a>
      <a class="dropdown-item">pradnniyashree.s2020@vitstudent.ac.in</a>
    </div>
  </div>
